export default {
  ...
  en: {
    CreatePlotStepFive: {
      ...
      subtitle: 'In the next steps, we will need samples of the planting, continue when you are close to the field, the steps taken so far have already been saved and will not be lost',
